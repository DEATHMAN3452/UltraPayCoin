...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/upc-dev-team/UltraPayCoin/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign UltraPayCoin Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit ultrapaycoin=v${VERSION} ../UltraPayCoin/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [ultrapaycoin-detached-sigs](https://github.com/upc-dev-team/ultrapaycoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/upc-dev-team/UltraPayCoin/releases/new) with a link to the archived release notes.
