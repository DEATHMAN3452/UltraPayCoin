...
In order to support loading of multiple wallets in ultrapaycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ultrapaycoin.cpp.
...
Changes to ultrapaycoin.cpp
----------------------
ultrapaycoin.cpp is the entry point into ultrapaycoin-qt, and as such, will require some minor modifications to provide hooks for
