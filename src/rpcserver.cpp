...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop UltraPayCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "UltraPayCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ultrapaycoin features */
        {"ultrapaycoin", "masternode", &masternode, true, true, false},
        {"ultrapaycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ultrapaycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ultrapaycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ultrapaycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ultrapaycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ultrapaycoin", "startmasternode", &startmasternode, true, true, false},
        {"ultrapaycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ultrapaycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ultrapaycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ultrapaycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ultrapaycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ultrapaycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ultrapaycoin", "mnbudget", &mnbudget, true, true, false},
        {"ultrapaycoin", "preparebudget", &preparebudget, true, true, false},
        {"ultrapaycoin", "submitbudget", &submitbudget, true, true, false},
        {"ultrapaycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ultrapaycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ultrapaycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ultrapaycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ultrapaycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ultrapaycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ultrapaycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ultrapaycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ultrapaycoin", "mnsync", &mnsync, true, true, false},
        {"ultrapaycoin", "spork", &spork, true, true, false},
        {"ultrapaycoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ultrapaycoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ultrapaycoind, or the -server option to ultrapaycoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ultrapaycoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13334/\n";
}
