                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("UltraPayCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a UltraPayCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ultrapaycoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About UltraPayCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about UltraPayCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for UltraPayCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your UltraPayCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified UltraPayCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a UltraPayCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the UltraPayCoin Core help message to get a list with possible UltraPayCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("UltraPayCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to UltraPayCoin network", "", count));
}
...
{
    QString strTitle = tr("UltraPayCoin Core"); // default title
