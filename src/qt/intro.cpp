...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("UltraPayCoin Core"),
     ...
     * override -datadir in the ultrapaycoin.conf file in the default data directory
     * (to be consistent with ultrapaycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
