...
/** Utility functions used by the UltraPayCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render UltraPayCoin addresses in monospace font
...
// Parse "ultrapaycoin:" URI into recipient object, return true on successful parsing
