...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("UltraPayCoin Core");
    ...
    QString copyrightTextLpcx = QChar(0xA9) + QString(tr(" 2018 The LightPayCoin Core developers"));
	QString copyrightTextUPC = QChar(0xA9) + QString(tr(" 2019 The UltraPayCoin Core developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextLpcx);
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextUPC);
