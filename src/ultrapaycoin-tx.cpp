...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ultrapaycoin Core ultrapaycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ultrapaycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ultrapaycoin transaction") + "\n" +
                               "  ultrapaycoin-tx [options] -create [commands]   " + _("Create hex-encoded ultrapaycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ultrapaycoin transaction
