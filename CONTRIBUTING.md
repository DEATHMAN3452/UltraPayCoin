Contributing to UltraPayCoin Core
============================

The UltraPayCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the UltraPayCoin Core project, and is not to be
confused with overall UltraPayCoin Network Protocol consensus changes.

Whether a pull request is merged into UltraPayCoin Core rests with the project merge
...
Patches that change UltraPayCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the UltraPayCoin consensus, it must have been
...
The project leader is the release manager for each UltraPayCoin Core release.
